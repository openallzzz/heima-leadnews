...
public class ApArticleServiceImpl extends ServiceImpl<ApArticleMapper, ApArticle> implements ApArticleService {
     ...
     */
    @Override
    public ResponseResult loadArticleList( Short loadtype, ArticleHomeDto dto) {
        // 1.校验参数
    ...
    public ResponseResult saveArticle(ArticleDto dto) {
        ...
        // 异步调用 生成静态页面文件并保存至minio中
        articleFreemarkerService.buildArticlePageToMinIO(article, dto.getContent());
